"""Authselect predefined profiles."""
...
class ProfileGroup(KnownTopologyGroupBase):
    ...
    AnyProvider = [Profile.SSSD, Profile.Winbind]
    """
    Profiles backed by a remote directory provider (SSSD/IPA and Winbind/Samba).
    Use for tests that require a provider group or user that is separate from
    local files, such as group-merging scenarios.

    .. topology-mark:: ProfileGroup.AnyProvider
    """
